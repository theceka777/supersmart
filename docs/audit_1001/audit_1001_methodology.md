# 1001 Audit — Methodology (v1, Session 13, 2026-04-24; **Phase 1 audit COMPLETE through batch 6, session 22, 2026-04-25**)
...
|---|---|---|---|---|---|---|
| 1 | Q1–Q100 (all science) | 80 | 20 | 0 | 0 | Session 13, 2026-04-24. Two full CD review passes. *Updated session 22 final-check pass: Q71 dinosaur extinction "65 million" → "66 million" added (current K-Pg consensus is 66.0 Mya; older 65M figure was the rounded estimate).* |
...
| 4 | Q301–Q400 (50 misc + 50 word) | 89 | 11 | 0 | 0 | Session 19, 2026-04-25. *Updated session 22 final-check: Q321 "German automobile manufacturer" Smart→BMW with distractors Buick/Pontiac→Ford/Toyota (Smart is now Mercedes+Geely JV; BMW is canonical brand-permanent German anchor).* Same shape as batches 2–3. **First word category coverage** — anagram cluster (Q352–Q386) ran very clean. Two retired-mode concept-replaces (Q331 Arcade→Quickmatch, Q332 Classic→Daily Race) — same pattern as Q265 in batch 3. **One corpus-wide style sweep deferred** to end-of-Phase-1: the "Make a word using  X" double-space prefix typo + Make/make capitalization split across Q352–Q386 (35 questions, identical fix). Per the "On corpus-wide stylistic decisions" section, tagged once and held for global sweep instead of 35 individual Lights. Three char-overflow Keeps (Q329 41ch, Q343 41ch, Q381 43ch) approved by CD discretion against the ≤40 ceiling — see ruling #15 below. |
| 5 | Q401–Q700 (125 word + 50 music + 30 movies + 95 math) | 277 | 23 | 0 | 0 | Session 21, 2026-04-25. *Updated session 22 final-check: Q594 Woody Allen→Christopher Nolan; "Annie Hall"→"Inception" with distractors "Pulp Fiction"/"Goodfellas" (cultural drift ruling #16 — Allen's reputation post-1992/2014 carries baggage).* **300-question mega-batch** — speed mode. Spans four categories. Word ran 11 Lights / 114 Keeps (91% Keep). Music 7 Lights / 43 Keeps (86%). Movies 3 Lights / 27 Keeps (90%). Math 0 Lights / 95 Keeps (100%). One Retire flag was raised on first pass (Q501 duplicate of Q326) — CD reframed to a Light-edit rewrite (group-of-goats puzzle), preserving the perfect zero-Retire streak. Two concept-replace Lights for durability: Q543 swapped Bieber → Taylor Swift answer ("Shake It Off"); Q595 swapped Will Smith → Tom Cruise (Will Smith's 2022 Oscar win invalidated the "never won" answer — first **already-effected fact change** in the audit, see ruling #14 extension below). One bug fix: Q478 distractor RIPPING also satisfied "contains g, r, n" (two valid answers) — swapped to CARBON. Source-XML typos: Q439 aggresive→aggressive, Q540 Satistfaction→Satisfaction, Q573 Suziki→Suzuki, Q576 Gywneth→Gwyneth, Q590 Brosnon→Brosnan. Capitalization Lights: Q407 Brussels, Q408 three name sets, Q451 Esperanto, Q464 Ella, Q565 Led Zeppelin / The Beatles, Q571 Van Halen. Distractor swaps for voice/durability: Q444 red pill → me (red-pill has gained political/manosphere meaning post-2012), Q463 kanye → brake, Q467 snoop → kendrick (lowercase per CD), Q466 line → lemon (cleaner non-rhyme). Stage-name punctuation: Q556 Jay Z → Jay-Z (with distractors hyphenated for visual consistency). Title punctuation: Q574 No Woman, No Cry. Second-pass added 4 finds (Q407, Q540, Q556, Q574) over the first pass — speed mode benefits from fresh-eyes review more than slower batches did. |
| 6 | Q701–Q1001 (80 math + 161 geography + 50 people + 10 literature) | 277 | 24 | 0 | 0 | Session 22, 2026-04-25 + final-check pass. **301-question final mega-batch — Phase 1 complete.** Per-category Keep: math 100% (80/80, pristine), geography 92% (148/161), people 82% (41/50), literature 90% (9/10). Geography ran clean except for a cluster of typos and one factual error (Q868 equator does not pass through Argentina — concept-replace to Brazil). One renamed-landmark fix (Q924 Sears→Willis Tower, ruling #14 already-effected). Two concept-replaces for voice/freshness: Q783 Ukrainian flag → Peru flag (avoid third Ukraine question), Q935 Everest "located in China" → "in the Himalayas mountain range" (sidesteps China-vs-Nepal summit ambiguity), Q979 French goalkeeper Barthez → famous French footballer Mbappé (contemporary anchor with foreign-superstar distractors C. Ronaldo / L. Messi). One cultural-drift Light per ruling #16: Q968 distractor "Bradley Manning" → "Bradley Cooper" (Manning came out as Chelsea in 2013, deadname). One source-XML broken-puzzle fix: Q988 "Pluto" → "Plato" (student of Socrates). One Latin typo: Q987 "Vini" → "Veni". Source-XML typos: Q799 Ukranian, Q814 Russua, Q821 Valetta, Q858 Phillipines, Q874 Swizterland, Q899 Kirku (Gurkha knife), Q942 Gaugin, Q960 Fraizer, Q969 Germanl, Q979 Frank Ribery, Q995 Sliverstein. Capitalizations: Q841 South africa, Q945 amadeus. Punctuation: Q953 Jean-Paul Gaultier, Q889 Hagia Sophia. Q955 (Tony Blare/Gordon Cameron) kept on CD voice call as intentional wordplay. Q909 (Indonesia population trick), Q951 (Sloan as Bulls player), Q935 (originally Mount Everest in China) kept after marginal-call review. People category came in well above the 40–60% original forecast — at 82%, the dated-cluster reservoir was much smaller than projected. |
...
| **Cumulative through batch 5** | **Q1–Q700 (700)** | **629** | **71** | **0** | **0** | **89.86% Keep / 10.14% Light.** |
| **PHASE 1 AUDIT COMPLETE** | **Q1–Q1001 (1001)** | **903** | **98** | **0** | **0** | **90.2% Keep / 9.8% Light / 0% Heavy / 0% Retire.** Final per-category: math 100%, science 82.5%, misc 88.7%, word 91.4%, music 84%, movies 86.7%, geography 91.3%, people 82%, literature 90%. Six batches plus a final-check pass across sessions 13/14/16/19/21/21b/22 (2026-04-24 → 2026-04-25). **Zero Heavy or Retire flags across the entire 1001-question corpus.** The original Part 8 projection of 700/150/100/50 (70/15/10/5 split) was off by a full order of magnitude on the bottom two tiers. Implication: the 1001 is significantly more durable than Phase 0 sampling suggested. The 98 Light edits cluster: ~30 source-XML typos, ~22 distractor-swap voice/durability fixes (incl. cultural drift Q444 red pill, Q533 Sarkozy, Q594 Woody Allen, Q968 Manning), ~16 capitalization-of-proper-nouns, ~12 concept-replaces (retired-mode references, already-effected fact changes — Q321 Smart→BMW, Q595 Will Smith→Tom Cruise, Q924 Sears→Willis, Q979 Barthez→Mbappé, etc.), ~10 phrasing/char-budget tightening, ~5 prompt typos, ~3 scientific currency updates (Q71 65M→66M for K-Pg). Methodology rulings finalized at 16. **Next:** corpus-wide style sweep (whitespace, capitalization residuals, the Q352–Q386 "Make a word using  X" cluster, the Q738/Q739/Q744/Q777 capitalized-first-word math cluster) before Phase 5 question writing. That's a separate session. | Five batches in (70% of corpus), **still zero Heavy or Retire flags.** The dated-cluster forecast for music + movies materialized only mildly: music 86% Keep, movies 90% Keep — both above the 40–60% original forecast, well above the people/music/movies attrition reservoir. Two concept-replaces in batch 5 (Q543 Bieber→Swift, Q595 Will Smith→Tom Cruise) handled durability without dropping questions. Math is the cleanest category yet (100% Keep across 95 questions). Remaining: 80 math + 161 geography + 50 people + 10 literature = 301 questions. The corpus-wide projection of 700/150/100/50 is now decisively wrong; running rate suggests final around 900/100/0/0 if late categories cooperate. People (Q942–Q991) is the last major attrition risk. |
