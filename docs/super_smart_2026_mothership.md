...
**Status:** v1.21 — Five "coffee decisions" locked in Appendix D pass (reset clock, tie-breakers, seasonal packs, localization, App Store subtitle); i18n schema hedge committed; Appendix D drops from 46 to 41 open items
...
*End of doc v1.21 — last updated 2026-04-24.*
