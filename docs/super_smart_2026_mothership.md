...
- ⏳ Audit all 1001 questions from the XML: Keep / Light edit / Heavy edit / Retire. **Through Q200 (sessions 13–14):** cumulative 171 Keep / 29 Light / 0 Heavy / 0 Retire across batches 1+2 (Q1–Q100 all science 81/19; Q101–Q200 last-20-science + first-80-misc 90/10). 801 questions to go — batches of ~100 per focused sitting. Methodology + per-batch tally tracked in `audit_1001/audit_1001_methodology.md` at parent folder.
