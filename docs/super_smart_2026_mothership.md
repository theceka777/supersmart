...
19. ~~**Streak Shield retroactive 48-hour clock anchor.**~~ ✅ **RESOLVED 2026-05-16 session 31c.** Anchor + detection mechanism + UX during window + edge cases all locked.
    ...
    **UX during the 48h window:**
    ...
    - **Tap to repair** opens a focused purchase sheet at standard #27 pricing — 1-pack highlighted as "repair the streak," 2/3-packs as "...and stock up." Multi-pack purchases: 1 shield activates retroactively, the rest go into inventory.
...
27. ~~**Streak Shield bundle pricing.**~~ ✅ **RESOLVED 2026-05-16 session 31.** **$0.99 / $1.79 / $2.49** for 1 / 2 / 3 packs respectively. Mild bulk discount: save $0.19 on the 2-pack (vs 2× $0.99), save $0.48 on the 3-pack (vs 3× $0.99). The 3-pack fills to inventory cap. All three sit comfortably under $2.99, which keeps Pro at $4.99 looking like the obvious power-user deal (unlimited rounds + seasonal packs + weekly free shield + Pro avatar items + Global all-time view + Pro badge — many features at less than 2× the 3-pack). Strategic intent: shields are an impulse purchase right after a streak loss ("I just lost my 14-day streak, here's a buck"), not a Pro replacement. Bundles reward the shield-only power user without cannibalizing Pro upgrades. **Store framing in voice:** `1 Streak Shield` — $0.99; `2 Streak Shields` *(save $0.19)* — $1.79; `Stock the vault — 3 Streak Shields` *(save $0.48)* — $2.49. **Out of scope of this decision** (flagged separately): whether free users can *earn* shields beyond the 1-at-launch grant (e.g. milestone unlock at 30-day streak) — that lives under Appendix D #9 (avatar milestone unlocks) and Phase 3 design work.
...
*End of doc v1.50 — last updated 2026-05-16.*
