...
**Status:** v1.22 — Clarification pass on league tier vs skill tier: league clusters are strict same-tier leaderboard cohorts, not matchmaking pools; the ±1 rule applies to skill tier (Quickmatch ghost matching) only. Earlier v1.21 locked the five Appendix D coffee decisions.
...
*End of doc v1.22 — last updated 2026-04-24.*
